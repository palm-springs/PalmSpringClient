...
export const useGetBlogHeaderInfo = (blogUrl: string) => {
  const { data } = useQuery({
    queryKey: [QUERY_KEY_BLOG.getBlogHeaderInfo, blogUrl],
    queryFn: () => getBlogHeaderInfo(blogUrl),
  });
  return data;
};
...
export const useGetBlogArticleList = (blogUrl: string, categoryId: string | null) => {
  const { data } = useQuery({
    queryKey: [QUERY_KEY_BLOG.getBlogArticleList, blogUrl, categoryId],
    queryFn: () => getBlogArticleList(blogUrl, categoryId),
  });
  return data;
};
...
export const useGetBlogArticleDetail = (blogUrl: string, articleId: number) => {
  const { data } = useQuery({
    queryKey: [QUERY_KEY_BLOG.getBlogArticleDetail, blogUrl, articleId],
    queryFn: () => getBlogArticleDetail(blogUrl, articleId),
  });
  return data;
};
...
export const useGetBlogCategoryList = (blogUrl: string) => {
  const { data } = useQuery({
    queryKey: [QUERY_KEY_BLOG.getBlogCategoryList, blogUrl],
    queryFn: () => getBlogCategoryList(blogUrl),
  });
  return data;
};
...
export const useGetBlogPageDetail = (blogUrl: string, pageUrl: string) => {
  const { data } = useQuery({
    queryKey: [QUERY_KEY_BLOG.getBlogPageDetail, blogUrl, pageUrl],
    queryFn: () => getBlogPageDetail(blogUrl, pageUrl),
  });
  return data;
};
...
export const useGetBlogAuthorDetail = (blogUrl: string, memberId: number) => {
  const { data } = useQuery({
    queryKey: [QUERY_KEY_BLOG.getBlogAuthorDetail, blogUrl, memberId],
    queryFn: () => getBlogAuthorDetail(blogUrl, memberId),
  });
  return data;
};
